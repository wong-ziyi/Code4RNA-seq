# Content Index
- [00.Basic information & opreation](.#00.Basic-information-&-opreation)
  - [00-00.Ubuntu location in Windows10](.#00-00.Ubuntu-location-in-Windows10)
...
```
### 01-05.Installation of Bowtie2
```bash
$ conda activate
$ conda install bowtie2
```
### 01-06.Installation of tophat2
```bash
...
```
### 01-08.Installation of rmats2sashimiplot
[Master repository in GitHub](https://github.com/Xinglab/rmats2sashimiplot)
```bash
$ conda activate py2
$ python setup.py install
```
### 01-09.Installation of Aspera connect
...
```
### 01-10.Installation of [subread](http://subread.sourceforge.net/)
```bash
...
```
### 01-11.Installation of cufflinks
```bash
$ sudo apt-get install cufflinks 
```
### 01-12.Installation of stringtie
```bash
$ conda install -c bioconda stringtie
```
### 01-13.Installation of Hisat2
```bash
$ conda activate py3
...
$ conda deactivate
```
## 02.Code example for bash (Unix/shell) language
### [02-01.Bash String Manipulation Examples – Length, Substring, Find and Replace](https://www.thegeekstuff.com/2010/07/bash-string-manipulation)
...
### 02-02.Code example for [bash (Unix/shell) language](https://tiswww.case.edu/php/chet/bash/bashref.html) with loop
#### Unzip gz file
```bash
#!/bin/bash
