...
```
A folder cotains "Uuntu", looks like `<CanonicalGroupLimited.Ubuntu18.04onWindows_79rhkp1fndgsc>`
...
|########Environment Setting########|
|----user login then enter root user
$ su - icmh
$ sudo -s
$ cd /home
...
Download 64-bit python 3.7 from (https://docs.conda.io/en/latest/miniconda.html)
...
--------------------------------------------------------
FASTa (Transcriptome; Date Modified: 5/24/19): ftp://ftp.ensembl.org/pub/release-97/fasta/mus_musculus/cdna/Mus_musculus.GRCm38.cdna.all.fa.gz
FASTa (Genome; Date Modified: 5/24/19): ftp://ftp.ensembl.org/pub/release-97/fasta/mus_musculus/dna/Mus_musculus.GRCm38.dna.toplevel.fa.gz
GTF (Date Modified: 5/26/19):ftp://ftp.ensembl.org/pub/release-97//gtf/mus_musculus/Mus_musculus.GRCm38.97.gtf.gz
...
(Reference genome) Downloaded from Ensembl (https://www.ensembl.org/index.html)
FASTa (Date Modified: 5/24/19): ftp://ftp.ensembl.org/pub/release-97/fasta/mus_musculus/dna/Mus_musculus.GRCm38.dna.primary_assembly.fa.gz
FASTa Transcriptome (Date Modified: 5/25/19): ftp://ftp.ensembl.org/pub/release-97/fasta/mus_musculus/cdna/Mus_musculus.GRCm38.cdna.all.fa.gz
GTF (Date Modified: 5/26/19): ftp://ftp.ensembl.org/pub/release-97/gtf/mus_musculus/Mus_musculus.GRCm38.97.chr.gtf.gz
--------------------------------------------------------
|%|%|%|%|%|%|%|Example for Index Building|%|%|%|%|%|%|%|
--------------------------------------------------------
...
|===###===Installation of rMATS===###===|
(http://rnaseq-mats.sourceforge.net/rmatsdockerbeta/index.html)
$ cd /home/InstallationPackages
...
|----installation of GSL (https://www.gnu.org/software/gsl/doc/html/intro.html#obtaining-gsl) and (https://coral.ise.lehigh.edu/jild13/2016/07/11/hello/)----|
$ cd gsl-2.5
$ chmod +x configure
...
for using vi(https://www.howtogeek.com/102468/a-beginners-guide-to-editing-text-files-with-vi/)
